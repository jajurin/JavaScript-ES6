...
function crearUsuario(nombre, edad){
 ...
 function mostrarResultado() {
    console.log("ejercio 1: ",formatearNombre("RAUL"))
    console.log("ejercio 2: ",contarLetras("RAUL ES"))
    console.log("ejercio 3: ",maximo(1, 2, 3))
    console.log("ejercio 4: ",validarPassword("RAULESHERO9"))
    console.log("ejercio 5: ",sumarArray([1,2,3,4,5]))
    console.log("ejercio 6: ",mayorNumero([1,2,3,4,5]))
   console.log("ejercio 7: ",obtenerPares([1,2,3,4,5]))
   console.log("ejercio 8: ",descripcionUsuario(usuario))
   console.log("ejercio 9: ",activarUsuario(usuario))
   console.log("ejercio 10: ",calcularPrecioTotalProductos(productos))
    console.log("ejercio 11: ",usuariosSoloNombre(usuarios))
    console.log("ejercio 12: ",usandoFilter(usuarios))
     console.log("ejercio 13: ",usandoReduce(usuarios))
     console.log("ejercio 14: ",usandoDestructing(producto))
     console.log("ejercio 15: ",usandoSpreadOperator(producto, productoStockSpreadOperator))
      console.log("ejercio 16: ",buscarProducto(productos, "Teclado"))
     console.log("ejercio 17: ",productosCarosDevolver(productos))
     console.log("ejercio 18: ",promedio([1,2,3,4,5]))
     console.log("ejercio Desafio final 1: ",obtenerUsuarios(usuariosFin))
     console.log("ejercio Desafio final 2: ",obtenerUsuarioPorId(usuariosFin,1))
     console.log("ejercio Desafio final 3: ",obtenerMayores(usuariosFin,18))
     console.log("ejercio Desafio final 4: ",crearUsuario("Damian",13))
